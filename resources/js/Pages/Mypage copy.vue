...
onMounted(async () => {
    ...
    const chartEl = document.querySelector('#stacked-column-chart');
          ...
          <ul class="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              ...
              <ul aria-expanded="false" class="sub-menu">
                <li>
                  <a href="mypage" key="t-default"> Default </a>
                </li>
                <li>
                  <a href="dashboard-saas.html" key="t-saas"> Saas </a>
                </li>
                <li>
                  <a href="dashboard-crypto.html" key="t-crypto"> Crypto </a>
                </li>
                <li>
                  <a href="dashboard-blog.html" key="t-blog"> Blog </a>
                </li>
                <li>
                  <a href="dashboard-job.html" key="t-jobs"> Jobs </a>
                </li>
              </ul>
            </li>
            <li>
            ...
            <li>
              ...
              <ul aria-expanded="false" class="sub-menu">
                ...
                <li>
                  <a href="job-details.html" key="t-job-details">
                    Job Details
                  </a>
                </li>
                <li>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="text-center">
                    ...
                    <a class="text-primary font-16" href="javascript: void(0);">
                      Learn more
                  ...
                  <ul class="verti-timeline list-unstyled">
                    <li class="event-list">
                      ...
                      <div class="d-flex">
                        ...
                        <div class="flex-grow-1">
                          <div>Responded to need âVolunteer Activities</div>
                        </div>
                      </div>
                    </li>
                    <li class="event-list">
                    ...
                    <li class="event-list active">
                      ...
                      <div class="d-flex">
                        ...
                        <div class="flex-grow-1">
                          <div>Joined the group âBoardsmanship Forumâ</div>
                        </div>
                      </div>
                    </li>
                    <li class="event-list">
                      ...
                      <div class="d-flex">
                        ...
                        <div class="flex-grow-1">
                          <div>Responded to need âIn-Kind Opportunityâ</div>
                        </div>
                      </div>
                    </li>
                  </ul>
