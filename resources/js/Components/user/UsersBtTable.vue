...
:deep(.us-success)   { background: #dcfce7; color: #16a34a; border-color: #bbf7d0; }
:deep(.us-danger)    { background: #fee2e2; color: #dc2626; border-color: #fecaca; }
:deep(.us-warning)   { background: #fef9c3; color: #ca8a04; border-color: #fde68a; }
:deep(.us-info)      { background: #dbeafe; color: #2563eb; border-color: #bfdbfe; }
:deep(.us-secondary) { background: #f1f5f9; color: #64748b; border-color: #e2e8f0; }
:deep(.us-contrast)  { background: #1e293b; color: #fff;    border-color: #334155; }
