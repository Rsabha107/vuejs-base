...
.table {
    ...
    --bs-table-hover-bg: rgba(var(--bs-tertiary-bg-rgb), 1);
    width: 100%;
    margin-bottom: 1rem;
    vertical-align: top;
...
[data-bs-theme="dark"] .form-select {
    --bs-form-select-bg-img: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16'%3e%3cpath fill='none' stroke='%23a6b0cf' stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='m2 5 6 6 6-6'/%3e%3c/svg%3e");
}
.form-check {
    display: block;
...
.form-switch .form-check-input {
    --bs-form-switch-bg: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='-4 -4 8 8'%3e%3ccircle r='3' fill='rgba%28116, 120, 141, 0.55%29'/%3e%3c/svg%3e");
    width: 2em;
    margin-left: -2.5em;
...
.was-validated .form-control:valid:focus {
    border-color: var(--bs-form-valid-border-color);
    -webkit-box-shadow: 0 0 0 0.15rem rgba(var(--bs-success-rgb), 0.25);
...
.was-validated .form-select:valid:not([multiple])[size="1"] {
    ...
    background-size:
        16px 12px,
        calc(0.75em + 0.47rem) calc(0.75em + 0.47rem);
}
...
.was-validated .form-control:invalid:focus {
    border-color: var(--bs-form-invalid-border-color);
    -webkit-box-shadow: 0 0 0 0.15rem rgba(var(--bs-danger-rgb), 0.25);
...
.nav-tabs {
    ...
    --bs-nav-tabs-link-active-border-color: var(--bs-border-color)
        var(--bs-border-color) var(--bs-secondary-bg);
...
.accordion {
    ...
    --bs-accordion-btn-active-icon: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%23222c5c'%3e%3cpath fill-rule='evenodd' d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z'/%3e%3c/svg%3e");
    --bs-accordion-btn-focus-border-color: rgb(var(--bs-body-color-rgb), 0.2);
    --bs-accordion-btn-focus-box-shadow: 0 0 0 0.15rem
        rgba(var(--bs-btn-focus-shadow-rgb), 0.5);
...
[data-bs-theme="dark"] .accordion-button::after {
    --bs-accordion-btn-icon: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%2399a8f0'%3e%3cpath fill-rule='evenodd' d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z'/%3e%3c/svg%3e");
    --bs-accordion-btn-active-icon: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%2399a8f0'%3e%3cpath fill-rule='evenodd' d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z'/%3e%3c/svg%3e");
}
.breadcrumb {
...
.link-primary:focus,
.link-primary:hover {
    color: RGBA(68, 88, 184, var(--bs-link-opacity, 1)) !important;
    -webkit-text-decoration-color: RGBA(
        68,
        88,
        184,
...
.link-secondary:hover {
    color: RGBA(93, 96, 113, var(--bs-link-opacity, 1)) !important;
    -webkit-text-decoration-color: RGBA(
        93,
        96,
        113,
...
.link-success:focus,
.link-success:hover {
    color: RGBA(42, 156, 114, var(--bs-link-opacity, 1)) !important;
    -webkit-text-decoration-color: RGBA(
        42,
        156,
        114,
...
.link-info:focus,
.link-info:hover {
    color: RGBA(64, 132, 193, var(--bs-link-opacity, 1)) !important;
    -webkit-text-decoration-color: RGBA(
        64,
        132,
        193,
...
.link-danger:focus,
.link-danger:hover {
    color: RGBA(195, 85, 85, var(--bs-link-opacity, 1)) !important;
    -webkit-text-decoration-color: RGBA(
        195,
        85,
        85,
...
.btn:focus {
    -webkit-box-shadow: 0 0 0 0.15rem rgba(var(--bs-btn-focus-shadow-rgb), 0.5);
    box-shadow: 0 0 0 0.15rem rgba(var(--bs-btn-focus-shadow-rgb), 0.5);
}
