...
//#endregion
//#region node_modules/vue-filepond/dist/vue-filepond.js
var require_vue_filepond = /* @__PURE__ */ __commonJSMin(((exports) => {
	/*!
	* vue-filepond v7.0.4
	...
	*/
	(function(global, factory) {
		if (typeof define === "function" && define.amd) define("vueFilePond", [
			"exports",
			"vue",
			"filepond"
		], factory);
		else if (typeof exports !== "undefined") factory(exports, require_vue(), require_filepond());
		else {
			var mod = { exports: {} };
		...
		var instances = [];
		var globalOptions = {};
		_exports.setOptions = function setOptions(options) {
			globalOptions = Object.assign(globalOptions, options);
			instances.forEach(function(instance) {
				instance.setOptions(globalOptions);
			});
		};
		_exports.default = function _default() {
			...
			return {
				...
				render: function render() {
					...
					return (0, _vue.h)("div", { class: { "filepond--wrapper": true } }, [(0, _vue.h)("input", attributes)]);
				},
				...
				beforeUnmount: function beforeUnmount() {
					...
					new MutationObserver(function mutationHandler(mutations, observer) {
...
//#endregion
export default require_vue_filepond();
